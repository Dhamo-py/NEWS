const getNews = async() => {
    ...
    try {
        const response = await axios.get("https://newsapi.org/v2/everything?q=${encodeURIComponent(word)}&from=2025-01-17&sortBy=publishedAt&apiKey=6c171fa58b324059827c3b5bdff44cfd");
